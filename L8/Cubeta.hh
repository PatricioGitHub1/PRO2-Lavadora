...
/** @class Cubeta
    ...
    Puede contener prendas blancas y de color. Puede usarse para intentar llenar una lavadora; en
   ese caso, las prendas se sacan de la cubeta en orden inverso al de entrada
*/
class Cubeta {
 public:
    // Constructoras
    ...
    */
    ...
    /** @brief Completa una lavadora con las prendas de la cubeta
        ...
        \post Se han eliminado del parámetro implícito y se han añadido a lav las prendas del
       parámetro implícito del color adecuado que más se acercan entre todas al peso máximo de lav
       sin pasarse, elegiéndose primero las que se introdujeron en último lugar
    ...
    */
    ...
    // en este ejemplo no documentamos los elementos privados, lo haremos en el
    // ejemplo de los experimentos inmunológicos (habrá que cambiar también el
    // Doxyfile)
 private:
