 ...
 *
 * Dispone de dos estados posibles (inicializada / no inicializada); si está inicializada tiene
 * un peso máximo y un color y puede contener prendas de dicho color hasta alcanzar dicho peso
 * máximo; si no está inicializada no contiene ninguna prenda y solo se puede inicializar
 *
...
class Lavadora {
 public:
     ...
     * @post El parámetro implícito es una lavadora vacía inicializada con peso máximo
     * "pmax" y color "col"
     */
     ...
     * @pre El parámetro implícito (L) está inicializado, color de p = color de L, peso de L
     * + peso de p <= peso máximo de L
     ...
     *
     * Representa que se realiza el lavado, se retiran la prendas que contiene la lavadora y
     * ésta queda en estado de volver a usarse
     *
     ...
     *
     * @pre El parámetro implícito está inicializado
     * @post Escribe las propiedades y el contenido del parámetro implícito por el canal estándar de
     * salida
     *
     * @coste Lineal respecto al número de prendas del parámetro implícito
     */
